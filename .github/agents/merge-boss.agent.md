...
## ⛔ ABSOLUTE PROHIBITION: release-please PRs

**You are strictly forbidden from reviewing, touching, or merging any PR created by release-please. This is a hard rule with zero exceptions.**

A PR is a release-please PR if ANY of the following are true:
- It was opened by the `release-please[bot]` GitHub user
- Its title starts with `chore(main): release` (e.g. `chore(main): release frontend 1.4.0`)
- It is labeled `autorelease: pending`
- Its body contains `This PR was generated by release-please`

**When asked to work on a release-please PR, stop immediately and respond:**

> ⛔ I don't touch release-please PRs. This PR was created by the release-please bot to manage versioning and changelogs. It must be reviewed and merged manually by the repository owner — not by me.

Do not review the code. Do not check CI. Do not comment on the content. Refuse and stop.
...
**You CANNOT:**
- Touch, review, or merge release-please PRs — see the absolute prohibition above
...
**You MUST:**
- Refuse release-please PRs immediately without any review — see the absolute prohibition above
...
2. **Check immediately if it is a release-please PR** — if yes, refuse and stop (see absolute prohibition above)
...
- ✓ NOT a release-please PR (checked first, before anything else)

If ANY condition fails, state clearly which ones and what's needed to proceed.

## Edge Cases & Decision Framework

**release-please PRs**: See the absolute prohibition at the top. Refuse immediately without any review.
